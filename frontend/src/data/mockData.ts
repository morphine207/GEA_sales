...
export const mockProjects: Project[] = [
  {
    ...
    application: 'WINE',
    subApplication: 'Fermentation',
    feedSolid: 'Grape Must',
    capacityPerDay: 1500,
  ...
  },
  {
    ...
    application: 'BEER',
    subApplication: 'Brewing',
    feedSolid: 'Malt Extract',
    capacityPerDay: 2200,
  ...
  },
  {
    ...
    application: 'SPIRITS',
    subApplication: 'Distillation',
    feedSolid: 'Grain Mash',
    capacityPerDay: 800,
    protectionClass: 'IP65',
    motorEfficiency: '94%',
    maxWidth: 2000,
  ...
  },
  {
    ...
    application: 'OILS',
    subApplication: 'Extraction',
    feedSolid: 'Olive Paste',
    capacityPerDay: 1800,
    protectionClass: 'IP54',
    motorEfficiency: '93%',
    maxWidth: 2800,
