...
export class Viewer
{
   ...
   SetAngle(angle_in_degree){
    let angle_in_rad = (angle_in_degree * Math.PI) / 180;
    let z = Math.cos(angle_in_rad);
    let y = Math.sin(angle_in_rad);
    ...
    this.navigation.SetCamera(NewCamera);
   }
